...
func SendReportWebhook(report *models.Report) {
	links := "[이미지 보기](https://dimi.monster/?id=&&id&&) | [이미지 삭제 처리](https://dimi.monster/admin/delete/&&id&&?key=&&key&&) | [이미지 삭제 및 차단 처리](https://dimi.monster/admin/deleteban/&&id&&?key=&&key&&) | [신고 철회 처리](https://dimi.monster/admin/withdraw/&&id&&?key=&&key&&) | [신고자 차단 처리](https://dimi.monster/admin/banreporter/&&id&&?key=&&key&&)"
